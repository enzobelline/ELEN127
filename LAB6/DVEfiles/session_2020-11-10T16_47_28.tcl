...
# DVE full session
# Saved on Tue Nov 10 16:47:28 2020
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{231 275} {1618 989}}
...
gui_sg_addsignal -group "$_session_group_12" { tb.datapath.stateMach.cState tb.datapath.stateMach.nState }

set _session_group_13 Group2
gui_sg_create "$_session_group_13"
set Group2 "$_session_group_13"

gui_sg_addsignal -group "$_session_group_13" { tb.datapath.stateMach.cState tb.datapath.stateMach.nState tb.respA tb.respB tb.start tb.done tb.sizeA tb.sizeB tb.reqA tb.reqB tb.reset tb.clk }

set _session_group_14 Group3
gui_sg_create "$_session_group_14"
set Group3 "$_session_group_14"

gui_sg_addsignal -group "$_session_group_14" { tb.sizeA tb.sizeB tb.reset tb.respA tb.respB tb.reqA tb.reqB tb.clk tb.done tb.start }
...
gui_wv_zoom_timerange -id ${Wave.1} 0 40
...
gui_marker_move -id ${Wave.1} {C1} 20
